...
class Account(db.Model):
    ...
    subscriptions_monthly_total = db.Column(db.Float)
    subscriptions_yearly_total = db.Column(db.Float)
    workfood_total = db.Column(db.Float)
    investments_total = db.Column(db.Float)
    familyentertainment_total = db.Column(db.Float)
    takeaway_total = db.Column(db.Float)
    transport_total = db.Column(db.Float)
    insurance_total = db.Column(db.Float)
